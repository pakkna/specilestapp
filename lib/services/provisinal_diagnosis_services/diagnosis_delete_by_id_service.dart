...
class DiagnosisDeleteByIdService with ChangeNotifier {
  var diagnosisdeletebyid;

  diagnosisDeleteById(String deleteId, BuildContext context) async {
    ...
    var response = await http.get(
        Uri.parse('${Api().baseUrl}/provisinal_diagnosis_delete/$deleteId'),
        // body: data,
        headers: header);
