...
class DeleteOrderLabService with ChangeNotifier {
  var deleteorderlab;

  deleteOrderLab(String deleteId, BuildContext context) async {
    ...
    var response =
        await http.get(Uri.parse('${Api().baseUrl}/delete_order_lab/$deleteId'),
            // body: data,
            headers: header);
